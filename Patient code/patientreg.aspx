<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="patientreg.aspx.cs" Inherits="patientreg" %>
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td class="style2">
                Age</td>
            <td class="style3">
                <asp:TextBox ID="_txtage" runat="server"></asp:TextBox>
            </td>
            <td>
                &nbsp;</td>
            <td>
        ...
        <tr>
            ...
            <td class="style3">
                <asp:DropDownList ID="_dpdType" runat="server" 
                    onselectedindexchanged="_dpdType_SelectedIndexChanged">
