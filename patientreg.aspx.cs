...
{  SqlDataReader rd;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            rd.Close();
           String sq = "insert into patientreg values('" + _txtName.Text + "','" + _txtadress.Text +"','" +_txtemail.Text +"','" +_txtcontact.Text +"','" +_txtage.Text +"','"+gender+"','"  +_dpdType.Text +"','"+_txtuname.Text+"','" +_txtpwd.Text +"')";
            //cmd = new SqlCommand(sq, cm);
            //cmd.ExecuteNonQuery();
           db.dbInsert(sq);
